...
index = python.index("n") #함수 index의 첫번째 n의 위치
print(index) #5
index = python.index("n", index + 1) #함수 index의 두번째 n의 위치
print(index) #15
print(python.find("java")) #함수 python속 java가 있는가 없으면 -1을 출력
print(python.count("n")) #함수 python속 n의 갯수